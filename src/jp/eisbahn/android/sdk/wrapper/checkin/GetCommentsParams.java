...
/**
 * コメント情報を取得する際に指定する条件を持つクラスです.
 * @author Yoichiro Tanaka
 *
 */
public class GetCommentsParams extends AbstractParams {
    ...
    /** 取得したい項目. */
    private CommentField[] fields = null;
     ...
     */
    public void setFields(final CommentField[] fields) {
        this.fields = fields;
    }
